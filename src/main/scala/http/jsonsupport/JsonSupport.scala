...
trait JsonSupport extends SprayJsonSupport with DefaultJsonProtocol {
  ...
  //we place an implicit jsonFormat for our domain object in scope. This will esentially signal Akka HTTP to produce a
  // JSON output from our ADT(Abstract Data Type).
